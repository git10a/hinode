...
const FAQ = [
    ...
    {
        q: '開始時間はいつですか？',
        a: '水曜の皇居ランと木曜の目黒川ランは6:00、日曜の代々木公園ランは7:15スタートです。時間通りにスタートしますので、開始5分前を目安に集合してください。',
    },
    {
        q: '日の出の時間はもっと早くありませんか？',
        a: 'はい、夏場は5時ごろに日の出を迎えます。日の出の瞬間だけでなく、朝の光の中を無理なく続けて走ることを大切にし、電車で来る方も参加しやすい時間にしています。日曜は近くのRuntrip BASEが7:00オープンのため、7:15集合です。',
    },
    {
        q: '何を持っていけばいいですか？',
