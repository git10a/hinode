        ...
        <section className={styles.manifestoPage}>
            <div className={styles.container}>
                ...
                <div className={`${styles.section} ${styles.fadeIn}`}>
                    ...
                    <p className={styles.body}>
                        日の出は、待ってくれない。集合の時刻は、こちらの都合で前後させられない。だから走る側が間に合わせる。その小さなやり取りのなかにしか、規律は宿らない。
                    </p>
                </div>
                ...
                <div className={`${styles.section} ${styles.fadeIn}`}>
                    ...
                    <p className={styles.body}>
                        約束するのは、時間に、場所にいること。日の出の時刻、決められた集合場所に、黒いHINODE Tシャツを着た誰かが必ずいる。一人で家を出られない朝も、先に誰かが待っている。
                    </p>
                    <p className={styles.body}>
                ...
                <div className={`${styles.section} ${styles.fadeIn}`}>
                    ...
                    <p className={styles.body}>
                        誰とも話さなくていい。黒いHINODE Tシャツを着た誰かに黙ってついて走り、黙って解散していい。一人参加でも、初参加でも、運動歴が浅くても、扱いは変わらない。
                    </p>
                    <p className={styles.body}>
