...
async function fetchPopularBlogPostIds() {
...
// GAへのPOSTはNextのデータキャッシュ対象外のため、リクエストごとの
// OAuth+runReport往復を避けて結果を1時間キャッシュする
export const getPopularBlogPostIds = unstable_cache(
    fetchPopularBlogPostIds,
    ['popular-blog-post-ids'],
    { revalidate: 3600 }
);
