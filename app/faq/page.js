...
const FAQ_GROUPS = [
    {
        ...
        items: [
            ...
            {
                q: '初参加におすすめの回はありますか？',
                a: '日曜7:15の代々木公園ラン（原宿時計塔前集合）がいちばん参加しやすいです。時間帯が朝早すぎず、参加人数も多い回です。',
            },
            {
                q: '集合場所でどうやってメンバーを見つければいいですか？',
                a: '背中に「HINODE」と書かれた黒いTシャツを着ているメンバーが目印です。気さくなメンバーばかりなので、遠慮なく声をかけてください。',
            },
        ],
    },
    {
        ...
        items: [
            {
                q: 'いつ、どこで開催していますか？',
                a: '毎週水曜6:00に皇居（桔梗門前派出所集合）、木曜6:00に目黒川（中目黒駅 蔦屋書店併設スターバックス前集合）、日曜7:15に代々木公園（原宿時計塔前集合）で開催しています。最新の日程は開催日程ページで確認できます。',
            },
            {
                q: '雨の日は開催されますか？',
            ...
            {
                q: 'どのくらいの距離を走りますか？',
                a: '回によりますが、おおむね2〜5kmです。皇居は1周約5km、目黒川は約4km、代々木公園は1〜2周で約2〜4kmです。',
            },
            {
                q: '走った後はどうなりますか？',
