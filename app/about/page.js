...
const FAQ_JSON_LD = {
    ...
    "mainEntity": [
        ...
        },
        {
            ...
            "acceptedAnswer": {
                "@type": "Answer",
                "text": "6月1日から、水曜の皇居ランと木曜の目黒川ランは6:00、日曜の代々木公園ランは7:10スタートです。時間通りにスタートしますので、2分前には集合しておいてください。"
            }
        },
        {
            "@type": "Question",
            ...
            "acceptedAnswer": {
                "@type": "Answer",
                "text": "はい、夏場は5時ごろに日の出を迎えます。6月1日からは1か月ほどサマータイムとして、水曜・木曜は6:00、日曜は7:10を試します。日曜は近くのRuntrip BASEが7:00オープンのため、7:10集合です。継続するかは参加状況や気温を見ながら判断します。"
            }
        },
        {
            "@type": "Question",
